...
<div>标题：<br />
<input type="text" name="news_name" style="width:90%;padding:5px;margin:0;" value="<%=news_one.getName()%>" /></div>

<div>内容：<br />
<textarea name="news_text" rows="3" cols="3" style="height:200px;"><%=news_one.getProp("text")%></textarea></div>
<div>显示级别：
